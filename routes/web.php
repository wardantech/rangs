...
use App\Http\Controllers\Consumption\WithdrawController;
...
Route::group(['middleware' => 'auth'], function(){
    ...
    Route::group(['namespace' => 'Requisition'], function () {
        ...
        Route::group(['prefix' => 'technician', 'as' => 'technician.'], function () {
            ...
            //Withdraw
            Route::get('withdraw/{id}', [WithdrawController::class,'create'])->name('withdraw');
            Route::post('withdraw-request/store', [WithdrawController::class,'store'])->name('withdraw-request.store');
            Route::get('withdraw-request', [WithdrawController::class,'index'])->name('withdraw-request.index');
            Route::get('withdraw-request/show/{id}', [WithdrawController::class,'show'])->name('withdraw-request.show');
            Route::get('withdraw-request/edit/{id}', [WithdrawController::class,'edit'])->name('withdraw-request.edit');
            Route::get('withdraw-request/approve/{id}', [WithdrawController::class,'approve'])->name('withdraw-request.approve');
