...
class CentralPartsReturnController extends Controller
{
    /**
    ...
    public function index()
    {
        try{
            ...
            return view('inventory.centralparts_return.index',compact('partsreturns'));
        } catch (\Exception $e) {
            $bug = $e->getMessage();
    ...
    public function show($id)
    {
        try{
            ...
            return view('inventory.centralparts_return.show',compact('partsreturn','partsReturnDetails'));
        } catch (\Exception $e) {
            $bug = $e->getMessage();
            return redirect()->back()->with('error', $bug);
        }
