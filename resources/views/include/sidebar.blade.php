        ...
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                @canany(['access_to_inventory', 'access_to_parts_receive', 'access_to_central_wareHouse_parts_stock',
                    ...
                    <div
                        class=" nav-item {{ \Request::is('inventory/create') ||\Request::is('inventory/show/*') ||\Request::is('inventory/edit') ||\Request::is('inventory/stock') ||\Request::is('inventory/show-inventory-details/*') ||\Request::is('inventory/stock-in-hand') ||\Request::is('inventory/stock-in-hand-all') ||\Request::is('inventory/part-category') ||\Request::is('inventory/parts') ||\Request::is('inventory/parts/*') ||\Request::is('inventory/price-management') ||\Request::is('inventory/price-management/*') ||\Request::is('inventory/parts_model') ||\Request::is('inventory/parts_model/*') ||\Request::is('inventory/source') ||\Request::is('inventory/source/*') ||\Request::is('inventory/store/*') ||\Request::is('inventory/store') ||\Request::is('inventory/racks') ||\Request::is('inventory/bins') ||\Request::is('inventory/bins/*') ||\Request::is('inventory/racks/*') ||\Request::is('inventory') ||\Request::is('central/requisitions/*') ||\Request::is('central/requisitions') ||\Request::is('central/re-allocation') ||\Request::is('central/re-allocation/edit/*') ||\Request::is('central/re-allocations') ||\Request::is('central/re-allocation/show/*') ||\Request::is('central/requisitions/allocation/*') ||\Request::is('central/requisitions/allocation') ||\Request::is('central/branch-parts-return/*') ||\Request::is('central/branch-parts-return') ||\Request::is('purchase/requisitions/*') ||\Request::is('purchase/requisitions') ||\Request::is('central/branch-parts-return/received/*') ||\Request::is('central/branch-parts-return/received') ||\Request::is('inventory/rack-bin-management/*') ||\Request::is('inventory/rack-bin-management') ||\Request::is('central/requisition-item') || \Request::is('central/requisitions/allocation-item') ? 'active open': '' }} has-sub">
                        ...
                        <div class="submenu-content">
                            ...
                            @canany(['access_to_inventory_branch_requisitions', 'access_to_branches_all_requisitions',
                                'access_to_branches_allocated_requisition', 'access_to_branches_re_allocated_requisition'])
                                <div
                                    class=" nav-item {{ \Request::is('central/requisitions/*') || \Request::is('central/requisitions') || \Request::is('central/re-allocations') || \Request::is('central/re-allocation/edit/*') || \Request::is('central/re-allocation/show/*') || \Request::is('central/requisitions/allocation/*') || \Request::is('central/requisitions/allocation') || \Request::is('central/requisition-item') || \Request::is('central/requisitions/allocation-item') ? 'active open' : '' }} has-sub">
                                    <a href="javascript:void(0)"
                                        class="menu-item {{ \Request::is('central/requisitions/*') || \Request::is('central/requisitions') || \Request::is('central/re-allocations') || \Request::is('central/re-allocation/edit/*') || \Request::is('central/requisitions/allocation/*') || \Request::is('central/requisitions/allocation') || \Request::is('central/requisition-item') || \Request::is('central/requisitions/allocation-item') ? 'active open' : '' }} has-sub">{{ __('label.BRANCH_REQUISITIONS') }}</a>
                                    <div class="submenu-content">
