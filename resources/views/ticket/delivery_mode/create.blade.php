            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header">
                        <h3>{{ __('label.PRODUCT_DELIVERY_MODE')}}</h3>
                    </div>
                    <div class="card-body">
                        <form class="" method="POST" action="{{ route('delivery-mode.store') }}">
                            @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="position-relative form-group">
                                        <label for="product_receive_mode_id">
                                            {{ __('label.PRODUCT_DELIVERY_MODE')}}
                                            <span class="text-red">*</span>
                                        </label>
                                        <input type="text" name="name" class="form-control" placeholder="Product Delivery Mode" value="{{old('name')}}" required>
                                        @error('name')
