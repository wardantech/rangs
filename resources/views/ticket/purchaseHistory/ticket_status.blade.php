                    ...
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                ...
                                @elseif ($id == 7)
                                    <a href="#"
                                        class="btn btn-outline-warning">{{ __('Delivered BY TL Tickets') }}</a>
                                @elseif ($id == 8)
                                    <a href="#" class="btn btn-outline-warning">{{ __('Reopened Tickets') }}</a>
                                @elseif ($id == 9)
                                    <a href="#"
                                        class="btn btn-outline-warning">{{ __('Delivered BY CC Tickets') }}</a>
                                @elseif ($id == 10)
            ...
            <div class="col-md-12">
                ...
                <div class="card p-3">
                    <div class="card-header">
                        ...
                        @endif
                        <div class="card-header">
                            <a href="{{ route('status.excel', $id) }}" class="btn btn-success text-center"
