...
@section('content')
                ...
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('tickets.claim', $ticket->id) }}" class="btn btn-info" title="Claim"
                                    target="_blank">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('tickets.slip', $ticket->id) }}" class="btn btn-success" title="Slip"
                                    target="_blank">
                                    <i class="fa fa-print" aria-hidden="true"></i>
                                    SLIP
                                </a>
        ...
        <div class="row print">
                        ...
                        <div class="card-header-right">
                            ...
                            @if ($ticket->status == 7 && $ticket->is_delivered_by_teamleader == 0)
                                @if ($is_teamleader != null || $user_role->name == 'Admin' || $user_role->name == 'Super Admin')
                                    <a href="" class="btn btn-primary" data-toggle="modal"
                                        data-target="#ticketDeliveryByTLModal" title="Click to Delivery">
                                        <i class='fas fa-check-circle'></i>
                            ...
                            @if ($ticket->status == 8 || $ticket->status == 10)
                                ...
                                @else
                                    ...
                                    @endif
                                @endif
                                @if($ticket->status == 10 && $ticket->is_delivered_by_call_center == 1 && $is_teamleader == null)
                                    <button class="btn btn-danger" title="Delivered By TL">
                                        <i class='fas fa-check-circle'></i>
                                        Delivered By CC
                                    </button>
                            ...
                            <tbody>
                                @if ($ticket->is_reopened == 1)
                                    ...
                                    <tr>
                                        ...
                                        <td style="color: rgb(255, 0, 0)">
                                            {{ $ticket->reopen_date ? $ticket->reopen_date->format('d/m/Y') : null }}</td>
                                    </tr>
                                @endif
                                <tr>
                                    <td>Status</td>
                                    <td>
                                        ...
                                        @elseif(
                                            $ticket->status == 6 &&
                                                $ticket->is_accepted == 1 &&
                                                $ticket->is_started == 0 &&
                                                $ticket->job->job_pending_note != null)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge badge-success">
                                            @if (isset($ticket->purchase->customer->grade->name))
                                                {{ $ticket->purchase->customer->grade->name }}
                                            @endif
                                        </span>
                                    </td>
                                </tr>
                                ...
                                @if ($ticket->fault_description_note)
                                    <tr>
                                        ...
                                        <td style="font-weight: bold; color:red">{{ $ticket->fault_description_note }}
                                        </td>
                                    </tr>
                                @endif
                                <tr>
                                        ...
                                        <div class="col-md-4 ">
                                            <div class="card">
                                                <div class="card-body shadow-lg">
                                                    ...
                                                    <div class="">
                                                        <p><strong>Recommendation Note: </strong>
                                        ...
                                        <div class="col-md-4 ">
                                            <div class="card">
                                                <div class="card-body box-shadow">
                                                    ...
                                                    <div class="">
                                                        <p><strong>Recommended Branch: </strong>
                                                            {{ $transfer->outlet->name }}</p>
                                                    </div>
                                                    <div class="">
                                                        <p><strong>Recommended By:
                                                            </strong>{{ $transfer->createdBy->name }}</p>
                                                    </div>
                                                    <div class="d-flex">
                                                        <p><strong>Recommended Note:
                                                            </strong>{{ $transfer->recommend_note }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        @foreach (json_decode($item->name) as $attachment)
                                            <div class="col-sm-2">
                                                <a href="{{ route('technician.photo.download', $attachment) }}"
                                                    class="ml-10">
                                                    <img id="" class="rounded mx-auto d-block mt-3 mb-3"
                                                        src="{{ asset('attachments/' . $attachment) }}" alt="Not Found"
                                                        height="150px" width="150px" title="Download">
                                                </a>
                                            </div>
                                        @endforeach
                                    @endforeach
            ...
            @if ($jobs)
                <div class="col-md-12">
                    <div class="card p-3">
                        <div class="card-body">
                            <div class="table-responsive" id="purchaseHistoryShow"><strong>
                                    {{ __('label.JOB_LIST') }}</strong>
                                <table id="datatable" class="table">
                                    <thead>
                                        <tr>
                                            <th>{{ __('label.SL') }}</th>
                                    ...
                                    <tbody>
                                        @forelse ($jobs as $job)
                                            <tr>
                                                ...
                                                <td>
                                                    @can('show')
                                                        <a href="{{ route('show-ticket-details', $job->ticket_id) }}"
                                                            class="badge badge-primary"
                                                            title="Ticket Details">TSL-{{ $job->ticket->id }}</a>
                                                    @endcan
                                                </td>
                                                <td>JSL-{{ $job->id }}</td>
    ...
    <div class="modal fade" id="demoModal" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                {{ Form::open(['route' => 'call-center.customer-feedback.store', 'class' => 'forms-sample', 'id' => 'createRank', 'method' => 'POST']) }}
                ...
                <div class="modal-footer">
                    ...
                    <a href="{!! URL::to('tickets/ticket/show', $ticketId) !!}"
                        class="btn btn-inverse js-dynamic-disable">{{ __('label.CENCEL') }}</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
    ...
    <div class="modal fade" id="ticketTransferModal" tabindex="-1" role="dialog"
        aria-labelledby="ticketTransferModal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" id="ticket_id" name="ticket_id"
                                        value="{{ $ticket->id }}">
                                    <input type="text" class="form-control" id="sl_number" name="sl_number"
                                        value="TSL-{{ $ticket->id }}" readonly>
                                    @error('sl_number')
    ...
    {{-- Ticket Re Open Note --}}
    <div class="modal fade" id="ticketReopenModal" tabindex="-1" role="dialog" aria-labelledby="ticketReopenModal"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
    ...
    <div class="modal fade" id="ticketDeliveryByCCModal" tabindex="-1" role="dialog"
        aria-labelledby="ticketDeliveryByCCModal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                            ...
                            <div class="col-sm-12">
                                <div class="position-relative form-group">
                                    <div class="border-checkbox-section">
                                        ...
                                        <input type="radio" id="yes" name="send_sms" value="1"
                                            class="send_sms" disabled>
                                        <label for="html">Yes</label>
                                        <input type="radio" id="no" name="send_sms" value="0"
                                            class="send_sms" checked>
    ...
    <div class="modal fade" id="ticketDeliveryByTLModal" tabindex="-1" role="dialog"
        aria-labelledby="ticketDeliveryByTLModal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
