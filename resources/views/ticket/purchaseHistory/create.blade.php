        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form class="form-prevent-multiple-submits" method="POST" action="{{ route('store-ticket') }}">
                            @csrf
                            ...
                            <fieldset class="form-group border p-3" style="background: #f9fafb">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input name="invoice_number"  placeholder="Invoice Number" type="text" class="form-control" value="{{ $purchase->invoice_number }}" readonly>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input name="date"  placeholder="Date" type="date" class="form-control" value="{{ currentDate() }}">
                                        @error('date')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-4">
                                        ...
                                        <input name="sl_number" id="sl_number" placeholder="Ticket Serial Number" type="text" class="form-control" value="{{ $ticket_sl }}" readonly>
                                        @error('sl_number')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="customer_id"  type="hidden" class="form-control" value="{{ $purchase->customer->id }}" readonly>
                                        <input name="customer"  placeholder={{ __('label.CUSTOMER')}} type="text" class="form-control" value="{{$purchase->customer->name}}" readonly>
                                        @error('customer')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="phone" id="phone" type="text" class="form-control" value="{{ $purchase->customer->mobile }}" readonly>
                                        @error('phone')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <input type="text" name="customer_reference" class="form-control" id="customer_reference" placeholder="Customer Reference" value="{{ old('customer_reference') }}">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="carrier" id="carrier" placeholder={{ __('label.CARRIER_NAME')}} type="text" class="form-control" value="{{ old('customer') }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="carrier_phone" id="" type="text" class="form-control" value="{{ old('carrier_phone') }}" placeholder={{ __('label.CARRIER_PHONE')}}>
                                        @error('carrier_phone')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <fieldset class="form-group border p-3" style="background: #fffbeb">
                                ...
                                <div class="form-row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input name="product_category_id"  placeholder="" type="hidden" class="form-control" value="{{ $purchase->category->id }}" readonly>
                                            <input name="product_category"  placeholder="" type="text" class="form-control" value="{{ $purchase->category->name }}" readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="brand_id"  placeholder="" type="text" class="form-control" value="{{ $purchase->brand->name }}" readonly>
                                            @error('brand_id')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input name="brand_model_id"  placeholder="" type="text" class="form-control" value="{{ $purchase->modelname->model_name }}" readonly>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input name="fault_description_note" type="text" class="form-control" value="{{ old('fault_description_note') }}">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input name="brand_id"  placeholder="" type="text" class="form-control bg-success {{$purchase->general_warranty_date->format("Y-m-d") < $currentDate ? 'bg-danger text-white' : ''}}" style="<?php ?>" value="{{ $purchase->general_warranty_date->format('m/d/Y') }}" readonly>
                                        @error('brand_id')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-4">
                                        ...
                                        <input name="special_warranty_date"  placeholder="" type="text" class="form-control bg-success {{$purchase->special_warranty_date->format("Y-m-d") < $currentDate ? 'bg-danger text-white' : ''}}" value="{{ $purchase->special_warranty_date->format('m/d/Y') }}" readonly>
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input name="brand_id"  placeholder="" type="text" class="form-control bg-success {{$purchase->service_warranty_date->format("Y-m-d") < $currentDate ? 'bg-danger text-white' : ''}}" value="{{ $purchase->service_warranty_date->format('m/d/Y') }}" readonly>
                            ...
                            <fieldset class="form-group border p-3" style="background: #eff6ff">
                                        ...
                                        <select name="job_priority_id" id="" class="form-control select2">
                                            ...
                                            @forelse ($job_priorities as $item)
                                                <option value="{{$item->id}}"
                                                    @if (old('job_priority_id') == $item->id)
                                                        selected
                                                    @endif
                                                >
                                                    {{$item->job_priority}}
                                        ...
                                        <select name="warranty_type_id" id="warranty_type_id" class="form-control select2">
                                            ...
                                            @forelse ($warrantyTypes as $warrantyType)
                                                <option value="{{$warrantyType->id}}"
                                                    @if (old('warranty_type_id') == $warrantyType->id)
                                                        selected
                                                    @endif
                                                >
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input name="start_date" type="date" class="form-control" value="{{ currentDate() }}">
                                        @error('start_date')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-4">
                                        ...
                                        <input name="end_date" type="date" class="form-control" value="{{ currentDate() }}">
                                        @error('end_date')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-4">
                                        ...
                                        <input name="customer_note" type="text" class="form-control" value="{{ old('customer_note') }}">
                                        @error('customer_note')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-row">
                                            ...
                                            @if(!empty($receiveModes))
                                                @forelse($receiveModes as $receiveMode)
                                                    <option value="{{$receiveMode->id}}"
                                                        @if(old('product_receive_mode_id') == $receiveMode->id)
                                                            selected
                                                        @endif
                                                        >
                                                        {{$receiveMode->name}}
                                            ...
                                            @if(!empty($deliveryModes))
                                                @forelse($deliveryModes as $deliveryMode)
                                                    <option value="{{$deliveryMode->id}}"
                                                        @if(old('expected_delivery_mode_id') == $deliveryMode->id)
                                                            selected
                                                        @endif
                                                        >
                                                        {{$deliveryMode->name}}
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input name="service_charge" type="text" class="form-control" id="service_charge" value="" readonly>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <div class="position-relative form-group">
                                            <div class="border-checkbox-section">
                                                <div class="border-checkbox-group border-checkbox-group-success">
                                                    <input class="border-checkbox" type="checkbox" name="send_sms" id="send_sms" value="1">
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        $.each(data, function(key, value){
                            if(value.id == ses){
                                $('#thana').append("<option selected value="+value.id+">"+value.name+"</option>");
                            }
