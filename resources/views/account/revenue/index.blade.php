    ...
    <div class="modal fade" id="demoModal" role="dialog" aria-labelledby="demoModalLabel" aria-hidden="true"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                {{ Form::open(['route' => 'create.revenue', 'class' => 'forms-sample', 'id' => 'createRank', 'method' => 'POST']) }}
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="name"
                                placeholder="Revenue Name" value="{{ old('name') }}" required>
                            @error('name')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="amount" class="form-control" id="amount"
                                placeholder="Amount" value="{{ old('amount') }}" min="0" required>
                            @error('amount')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
