...
@section('title', 'Brand Model Update')
@section('content')
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('label.BRAND_MODEL_UPDATE')}}</h5>
            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header">
                        <h3>{{ __('label.BRAND_MODEL_UPDATE')}}</h3>
                    </div>
                    <div class="card-body">

                        {{ Form::model($partsModel,array('role' => 'form', 'url' => 'product/brand_model/'.$partsModel->id, 'files'=> true, 'class' => 'form-horizontal', 'id'=>'edit', 'method'=> 'put')) }}
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="category_id">{{ __('label.SELECT_CATEGORY')}}<span class="text-red">*</span></label>
                                        {!! Form::select('product_category_id', $categories, null,[ 'class'=>'form-control select2', 'placeholder' => __('label.SELECT_CATEGORY'),'id'=> 'product_category_id']) !!}
                                ...
                                <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            {!! Form::select('brand_id',$brands,  null,[ 'class'=>'form-control select2', 'placeholder' => 'Select Brand','id'=> 'brand_id']) !!}
                                            <div class="help-block with-errors"></div>
                                            @error('brand_id')
                                                <span class="text-red-error" role="alert">
                                                    <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('model_name', Request::old('model_name'), array('id'=> 'model_name', 'class' => 'form-control', 'placeholder' => 'Enter Model')) }}
                                        <div class="help-block with-errors"></div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="code" class="form-control" value="{{old('code',optional($partsModel)->code)}}">
                                        <div class="help-block with-errors"></div>
    ...
    <script type="text/javascript">
        ...
        let cat_id = $('#product_category_id').val();
