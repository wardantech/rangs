                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 m-auto">
                        <div class="authentication-form mx-auto">
                            <div class="logo-centered">
                                <a href="https://wardan.tech"><img height="35" src="{{ asset('img/logo2.webp') }}" alt="Wardan Tech" ></a>
                            </div>
                            <p>Welcome back! </p>
                            ...
                            @csrf
                                ...
                                <div class="register">
                                    ...
                                    <h1> <a href="{{url('ticket/tracking')}}">{{ __('Service Tracking')}}</a></h1>
                                </div>
