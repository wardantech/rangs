            ...
            <div class="col-md-12">
                <div class="card p-3">
                    <div class="card-header">
                        <h3>@lang('label.GROUP')</h3>
                        @can('create')
                            <div class="card-header-right">
                                <a class="btn btn-info" href="{{ route('general.group.create') }}">
                                    @lang('label._CREATE')
                                </a>
                            </div>
                        @endcan
        ...
        $(document).ready( function () {
            ...
            var dTable = $('#group_datatable').DataTable({
                ...
                columns: [
                    ...
                    {data:'regionName', name: 'regionName', orderable: true, searchable: true},
