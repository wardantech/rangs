                ...
                <div class="card p-3">
                    <div class="card-header">
                        ...
                        <div class="card-header-right">
                            <p>
                                {{ Carbon\Carbon::parse($formattedCurrentDate)->format('m/d/Y') }}
                            </p>
                        </div>
                    </div>
...
<script type="text/javascript">
        $(document).ready( function () {
            ...
            var dTable = $('#datatable').DataTable({
                ...
                ajax: {
                    url: "{{route('report.finance-report-get')}}",
                    type: "get"
                },
                columns: [
                    { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
                    {data:'name', name: 'name', orderable: true, searchable: true},
                    {data:'days_total_collection', name: 'days_total_collection', orderable: true, searchable: true},
                    {data:'collection', name: 'collection', orderable: true, searchable: true},
                    {data:'collection', name: 'collection', orderable: true, searchable: true},
                    {data:'days_total_deposit', name: 'days_total_deposit', orderable: true, searchable: true},
                    {data:'deposit', name: 'deposit', orderable: true, searchable: true},
