                    ...
                    <div class="card-header">
                        ...
                        @can('create')
                            <div class="card-header-right">
                                <a href="{{route('technician.parts-return.create')}}" class="btn btn-primary">
                                    @lang('label.CREATE')
                                </a>
                            </div>
                        @endcan
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class='text-center'>
                                            @can('show')
                                                <a href="{{route('technician.parts-return.show', $partsreturn->id)}}" title="View Details" class="show-priceManagement">
                                                    <i class='ik ik-eye f-16 mr-15 text-green' title="View"></i>
                                                </a>
                                            @endcan

                                            @can('edit')
                                                @if($partsreturn->is_received == 0)
                                                    <a href="{{route('technician.parts-return.edit', $partsreturn->id)}}" title="Update" class="show-priceManagement">
                                                        <i class='ik ik-edit f-16 mr-15 text-blue' title="Edit"></i>
                                                    </a>
                                                @else
                                                    <span><i class='ik ik-edit f-16 mr-15 text-yellow' title="Can't Edit"></i></span>
                                                @endif
                                            @endcan
                                            ...
                                            @else
                                                <span><i class="ik ik-trash-2 f-16 text-yellow" title="Can't Delete"></i></span>
                                            @endif
                                            @endcan
                                        </div>
                                    </td>
