        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    {{ Form::open(array('route' => 'branch.parts-return.receive.store', 'class' => 'forms-sample', 'id'=>'','method'=>'POST')) }}
                    @csrf
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="sl_number" name="sl_number" value="T-RSL-{{ $partsReturn->id }}" readonly>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label for="orderDate">{{ __('label.RECEIVE DATE')}}<span class="text-red">*</span></label>
                                ...
                                <table id="datatable" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" class="form-control" id="receiving_quantity-{{$key}}" onInput="warning({{$key}})" name="receiving_quantity[]" min="0" value="{{ old('receiving_quantity[]') }}" required>
