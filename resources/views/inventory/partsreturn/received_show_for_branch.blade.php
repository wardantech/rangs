                    ...
                    <div class="card-body">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>T-RSL-{{$partsreturn->partsReturn->id}}</td>
                            </tr>
                            <tr>
                        ...
                        <table id="table" class="table">
                            ...
                            <tr>
                                ...
                                <td>{{$partsreturn->part->name}}-{{$partsreturn->part->code}}</td>
                                <td>{{$partsreturn->rack ? $partsreturn->rack->name : ''}}</td>
                                <td>{{$partsreturn->bin ? $partsreturn->bin->name : ''}}</td>
                                <td>{{$partsreturn->required_quantity}}</td>
                                <td>{{$partsreturn->received_quantity}}</td>
                            </tr>
                            @endforeach
                            </tbody>
                        </table>
