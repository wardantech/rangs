...
@section('title', 'Update Receive Parts')
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    {{ Form::open(array('route' => 'central.parts-return.receive.update', 'class' => 'forms-sample', 'id'=>'','method'=>'POST')) }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="sl_number" name="sl_number" value="B-RSL-{{ $ReceivedParts->partsReturn->id }}" readonly>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label for="orderDate">{{ __('Return Request Date')}}<span class="text-red">*</span></label>
                                    <input type="text" class="form-control" id="date" name="date" value="{{ $ReceivedParts->partsReturn->date->format('m/d/Y') }}" readonly>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="date" name="date" value="{{ $ReceivedParts->date->toDateString() }}">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-sm-3">
