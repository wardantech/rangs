                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @can('show')
                                            ...
                                            <a href="{{route('central.branch-parts-return.show', $partsreturn->id)}}" title="View Details" class="show-priceManagement">
                                                <i class='ik ik-eye f-16 mr-15 text-green'></i>
                                            </a>
                                        @endcan
                                        @if($partsreturn->status == 0)
                                            <a href="{{route('central.parts-return.receive', $partsreturn->id)}}" title="Receive" class="show-priceManagement">
                                                <i class="fa fa-check-square f-16 mr-15 text-green" aria-hidden="true"></i>
                                            </a>
                                        @else
                                            <i class="fa fa-check-square f-16 mr-15 text-yellow" aria-hidden="true" title="You can't receive"></i>
                                        @endif
                                        </div>
                                    </td>
                                </tr>
