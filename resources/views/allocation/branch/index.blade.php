                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class='' style="display: flex;">
                                                @can('create')
                                                    @if ($allocation->is_reallocated_received == 0 && $allocation->is_received == 0)
                                                        <a href="{{route('branch.requisition-receive-form',$allocation->id)}}" title="Receive Now"><i class="fa fa-check-square f-16 mr-15 text-green" aria-hidden="true"></i></a>
                                                    @else
                                                ...
                                                @endcan
                                                @can('show')
                                                    <a  href="{{ route('branch.allocation-details', $allocation->id) }}">
