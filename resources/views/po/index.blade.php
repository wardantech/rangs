            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Purchase requisitions')}}</h5>
                            <span>{{ __('Purchase requisitions list')}}</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
    ...
    <script type="text/javascript">
        $(document).ready( function () {
            ...
            var dTable = $('#datatable').DataTable({
                ...
                ajax: {
                    url: "{{route('purchase.requisitions.index')}}",
                    type: "get"
                },
                columns: [
                    { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
                    {data:'po_date', name: 'po_date', orderable: true, searchable: true},
