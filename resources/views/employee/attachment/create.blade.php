    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-body">
                        <form method="post" action="{{ url('technician/submission/photo/store') }}"
                            ...
                            <div class="row mb-2">
                                <div class="col-sm-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" class="form-control" id="job_no" name="job_no"
                                            value="JSL-{{ $job->id }}" placeholder="Job No" readonly>
                                        @error('job_no')
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" id="job_no" name="job_no"
                                            value="TSL-{{ $job->ticket->id }}" placeholder="Job No" readonly>
                                        @error('job_no')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" id="job_no" name="job_no"
                                            value="{{ $job->ticket->purchase->category->name }}" placeholder="Job No"
                                            readonly>
                                        @error('job_no')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-12">
                                    <div class="input-group control-group increment">
                                        ...
                                        <div class="input-group-btn">
                                            <button class="btn btn-success pl-1" type="button"><i
                                    ...
                                    <div class="clone hide">
                                        <div class="control-group input-group" style="margin-top:10px">
                                            ...
                                            @enderror
                                            <div class="input-group-btn">
                                                <button class="btn btn-danger pl-1" type="button"><i
