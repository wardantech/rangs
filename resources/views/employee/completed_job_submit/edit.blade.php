...
@section('title', 'Update Submit Job')
@section('content')
            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header my-3">
                        <h3>{{ __('Update Submit Job')}}</h3>
                    </div>
                    <div class="card-body">

                        <form action="{{ route('technician.submitted-jobs.update', $jobSubmission->id) }}" class="form-prevent-multiple-submits" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" id="submission_date" name="submission_date" value="{{ $jobSubmission->submission_date->toDateString() }}">
                                            ...
                                            <table id="datatable" class="table">
                                                ...
                                                @foreach ($inventoryStocks as $key=>$value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control" id="part_name" name="part_name[]" value="{{ $value->part->code }} - {{ $value->part->name }}" readonly>
                                                            <input type="hidden" name="part_id[]" value="{{ $value->part_id }}">
                                                        </td>
                                                        <td>
                                                            @if ($value->part->type==1 )
                                                                <input type="text" class="form-control" id="unit_price" name="" value="General" readonly>
                                                            @elseif($value->part->type==2)
                                                        ...
                                                        <td>
                                                            <input type="number" class="form-control" id="used_quantity" name="used_quantity[]" value="{{ $value->used_quantity }}" readonly>
                                                        </td>
                                                        <td>
                                                            <input type="text" class="form-control" id="selling_price_bdt-{{$key}}" name="selling_price_bdt[]" value="{{ $value->selling_price_bdt }}" readonly>
                                                            <input type="hidden" class="form-control" id="hidden_selling_price_bdt-{{$key}}" name="hidden_selling_price_bdt[]" value="{{ $value->selling_price_bdt }}" readonly>
                                                        </td>
                                                        <td>
                                                            <input type="text" class="form-control sum-value get-values part-vlaue" id="subtotal_selling_price_bdt-{{$key}}" name="subtotal_selling_price_bdt[]" value="{{ $value->selling_value }}" readonly>
                                                            <input type="hidden" class="form-control" id="hidden_subtotal_selling_price_bdt-{{$key}}" name="hidden_subtotal_selling_price_bdt[]" value="{{ $value->selling_price_bdt * $value->used_quantity }}" readonly>
                                                            @php
                                                                $total += $value->selling_value;
                                                            @endphp
                                                        </td>
                                                        @if (!empty($value->selling_price_bdt)))
                                                            <td>
                                                                <input type="checkbox" class="get-values" id="billcheckbox-{{$key}}" onInput="addToBill({{$key}})" name="checkbox" value="yes"{{ $value->selling_value > 0 ? 'checked' : '' }} style="width:20px; height:20px; margin-top: 13px;" />
                                                ...
                                                <table class="table">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input class="form-control sum-value get-values" type="number" name="fault_finding_charges" id="fault_finding_charge" min="0" value="{{ $jobSubmission->fault_finding_charges }}">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input class="form-control sum-value get-values" type="number" name="repair_charges" id="repair_charge" min="0" value="{{ $jobSubmission->repair_charges }}">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input class="form-control sum-value get-values" type="number" name="other_charges" id="other_charges" min="0" value="{{ $jobSubmission->other_charges }}">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input class="form-control sub-value get-values" type="number" name="discount" id="discount" min="0" value="{{ $jobSubmission->discount }}">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input class="form-control sub-value" type="number" name="advance_amount" id="advance_amount" value="{{ $jobSubmission->advance_amount }}" readonly>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input class="form-control mod-value get-values" type="number" name="vat" id="vat" min="0" placeholder="Please Enter Vat %" value="{{ $jobSubmission->vat }}">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Total Amount:</td>
                                                            ...
                                                            <td>
                                                                <input class="form-control" type="number" name="total" id="total" value="{{ $jobSubmission->total_amount }}" readonly>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="remark" id="" class="form-control" cols="30" rows="1">{{ $jobSubmission->remark }}</textarea>
                            </div>
                            <div>
    ...
    <script type="text/javascript">
        // Total Bill Description Function
