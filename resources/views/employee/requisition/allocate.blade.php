        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form class="form-prevent-multiple-submits" method="POST" action="{{ route('branch.requisition-allocate.store') }}">
                        @csrf
                            <div class="row">
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label for="requisition_no">{{ __('Requisition No')}}</label>
                                        <input type="text" class="form-control" id="requisition_no" name="requisition_no" value="{{ $requisition->requisition_no }}" readonly>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label for="orderDate">{{ __('label.REQUISITION_DATE')}}</label>
                                        <input type="text" class="form-control" id="date" name="date" value="{{ $requisition->date->format('m/d/Y') }}" readonly>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="date" name="date" value="JSL-{{ $requisition->job->id }}" readonly>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="allocation_date">{{ __('label.ALLOCATION_DATE')}}<span class="text-red">*</span></label>
                                        <input type="date" class="form-control" id="allocation_date" name="allocation_date" value="{{ currentDate() }}" required>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="outlate_id">{{ __('Technician Name')}}</label>
                                        <input type="hidden" name="requisition_id" value="{{ $requisition->id }}">
                                        <input type="hidden" name="from_store_id" value="{{ $requisition->from_store_id }}">
                                    ...
                                    <table id="datatable" class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="number" class="form-control" data-id="{{$key}}" id='stock_in_hand-{{$key}}' name="stock_in_hand[]" value="{{ $stock_collect[$key] }}" min="0" readonly>
                                                ...
                                                <td>
                                                    <input type="number" class="form-control" id="issue_quantity-{{$key}}" onInput="warning({{$key}})" name="issue_quantity[]" value="{{ old('issue_quantity[]') }}" placeholder="Enter Quantity" min="0" required>
