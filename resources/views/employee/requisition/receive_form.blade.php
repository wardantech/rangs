        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <form class="form-prevent-multiple-submits" method="POST" action="{{ route('technician.requisitionReceiveStore') }}">
                    @csrf
                        <div class="row">
                            <div class="col-sm-3">
                                <input type="hidden" name="allocation_id" value="{{ $allocation->id }}">
                                <input type="hidden" name="requisition_no" value="{{ $allocation->requisition->requisition_no }}">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="date" name="date" value="JSL-{{ $allocation->requisition->job->id }}" readonly>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="date" name="date" value="{{ $allocation->date->format('m/d/Y') }}" readonly>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <label for="orderDate">{{ __('label.RECEIVING_DATE')}}<span class="text-red">*</span></label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="store_id" value="{{ $allocation->store_id }}">
                                    <input type="text" class="form-control" id="date"  value="{{ $allocation->requisition->store->name }}" readonly>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="to_store_id">{{ __('Request To (Store)')}}</label>
                                    <input type="hidden" name="to_store_id" value="{{ $allocation->to_store_id }}">
                                ...
                                <table id="datatable" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" class="form-control" id="issued_quantity-{{$key}}" name="issued_quantity[]" value="{{ $detail->issued_quantity }}" readonly><input type="hidden" name="part_id[]" value="{{ $detail->parts_id }}">
                                            </td>
                                            <td>
                                                <input type="number" class="form-control" id="receiving_quantity-{{$key}}" onInput="warning({{$key}})" name="receiving_quantity[]" required>
