...
@section('title', 'Edit Technician Allocation')
@section('content')
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Edit Technician Allocation')}}</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <form action="{{ route('branch.technician.allocations.update', $allocation->id) }}" class="form-prevent-multiple-submits"  method="POST">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="requisition_no" name="requisition_no" value="{{ $allocation->requisition_no }}" readonly>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="allocation_date" name="allocation_date" value="{{ $allocation->allocation_date->toDateString() }}" required>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                ...
                                <table id="datatable" class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" class="form-control" id="balance_quantity-{{$key}}" onInput="warning({{$key}})" name="balance_quantity[]" value="{{ $detail->requisition_quantity - $detail->issued_quantity}}" min="0" readonly></td>
                                            <td>
                                                <input type="number" class="form-control" id="issue_quantity-{{$key}}" onInput="warning({{$key}})" name="issue_quantity[]" min="0" value="{{ $detail->issued_quantity }}" required>
