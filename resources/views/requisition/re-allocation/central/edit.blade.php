...
@section('title', 'Edit Re-allocate Requisition')
@section('content')
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('Edit Re-allocate Requisition')}}</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <form action="{{ route('central.re-allocation.update', $allocation->id) }}"  method="POST">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="date" name="date" value="{{  $allocation->allocation_date->toDateString() }}" required>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-sm-3">
