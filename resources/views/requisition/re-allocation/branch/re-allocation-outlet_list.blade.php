            ...
            <div class="col-md-12">
                <div class="card p-3">
                    <div class="card-header">
                        <h3>{{ $mystore ? $mystore->name :'' }} @lang('label.REALLOCATEION_REQUISITION_LIST')</h3>
                    </div>
                    <div class="card-body">
                        <table id="datatable" class="table">
                            <thead>
                                <tr>
                                    ...
                                    {{-- <th title="Balance Quantity">{{ __('Balance Qty')}}</th> --}}
                                    <th>{{ __('Status')}}</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class='' style="text-align: right;">
                                                @can('create')
                                                    @if($allocation->is_received != 1)
                                                        <a href="{{route('branch.re-allocated-receive',$allocation->id)}}">  <i class="fa fa-check-square f-16 mr-15 text-green" aria-hidden="true"></i></a>
                                                    @else
                                                        <i class="fa fa-check-square f-16 mr-15 text-yellow" title="Already Received" aria-hidden="true"></i>
                                                    @endif
                                                @endcan
                                                @can('show')
                                                <a  href="{{ route('branch.re-allocation.show', $allocation->id) }}">
        ...
        buttons: [
                {
                    ...
                    title: 'Re-Allocated Requisitions',
                    header: false,
                    footer: true,
                    exportOptions: {
                        // columns: ':visible'
