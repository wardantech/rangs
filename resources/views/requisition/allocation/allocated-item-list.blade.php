    ...
    <script type="text/javascript">
        $(document).ready( function () {
            ...
            var dTable = $('#datatable').DataTable({
                ...
                ajax: {
                    url: "{{url('central/requisitions/allocation-item')}}",
                    type: "get"
                },
                columns: [
                    {data:'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
                    {data:'requisition_date', name: 'requisition_date', orderable: true, searchable: true},
                    {data:'allocation_date', name: 'allocation_date', orderable: true, searchable: true},
                    ...
                    {data:'part_category', name: 'part_category', orderable: true, searchable: true},
                    {data:'tsl_no', name: 'tsl_no', orderable: true, searchable: true},
                    {data:'purpose', name: 'purpose', orderable: true, searchable: true},
                    {data:'requisition_quantity', name: 'requisition_quantity', orderable: false, searchable: false},
