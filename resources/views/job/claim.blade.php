...
<body onload="window.print();">
    <table>
        <tr>
            ...
            <th style="text-align: center">
                ...
                <span style="padding: 5px; border:1px solid rgb(74, 74, 74)">TSL-{{ $job->ticket->id }}</span>
            </th>
            <th>
    ...
    <table border="1" class="custom-complainment">
        ...
        <tr>
            ...
            @if ($job->ticket->product_condition_id)
                @php
                $product_conditionId = json_decode($job->ticket->product_condition_id);
                @endphp
                <td>
        ...
        <tr class="charge" style="padding: 6px;">
            <td>{{ $job->ticket->createdBy->name }}</td>
            <td rowspan="2"></td>
            <td>
